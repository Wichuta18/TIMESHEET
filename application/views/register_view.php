...
<div class="signup-form">	
    <form action="<?php echo base_url() ?>register_ctrl/validation" method="post">
		...
		<div class="form-group">
            <input type="submit" name="register" value="Register" class="btn btn-primary btn-block btn-lg">
        </div>
		<!-- <p class="small text-center">By clicking the Sign Up button, you agree to our <br><a href="#">Terms &amp; Conditions</a>, and <a href="#">Privacy Policy</a>.</p> -->
    </form>
	<div class="text-center">Already have an account? <a href="<?php echo base_url("login_ctrl/index") ?>">Login here</a>.</div>
</div>
</body>
</html>                            