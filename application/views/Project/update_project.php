                                    ...
                                    <form class="form-group col-12" id="user_form" method="Post" action="<?php echo base_url('project_ctrl/update_data/'.$data->idProject); ?>">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                ...
                                                <input data-format="dd/MM/yyyy" class="form-control" type="date" id="startDate" name="startDate" value="<?php echo $data->startDate?>">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="endD">End Date</label>
                                                <input data-format="dd/MM/yyyy" class="form-control" type="date" id="endDate" name="endDate" value="<?php echo $data->endDate?>">
                                            </div>
                                        </div>
                                        <br>
